...
<div class="col-sm-12 startup borders">
    ...
    <div class="row profile">
        <button type="button" class="btn btn-default profile" id="like" aria-label="Left Align">
            <span class="glyphicon glyphicon-thumbs-up" aria-hidden="true"></span></button>
        <a id="likes">0</a>
            <button type="button" class="btn btn-default profile" id="dislike" aria-label="Left Align">
